...
pub enum Commands {
    ...
    /// [Primary] Initialize a new Batonel project configuration
    Init {
    ...
    /// [Primary] Plan the architecture based on contracts and schemas
    Plan {
        /// Render format for the plan output
        #[arg(long, value_enum, default_value = "text")]
        format: PlanOutputFormat,
    },
    /// [Primary] Scaffold code structure and artifact sidecars
    Scaffold,
    /// [Primary] Verify the consistency of project structure and artifact contracts
    Verify,
    ...
    /// [Advanced] Generate an AI handoff prompt for a specific artifact or contract
    Prompt {
    ...
    /// [Governance] Audit baseline architecture compliance checks for PR gate usage
    Audit {
    ...
    /// [Governance] Run sidecar guard checks explicitly for init/plan/ci hooks
    Guard {
    ...
    /// [Governance] Aggregate compliance across multiple repositories and export JSON/CSV metrics
    ComplianceReport {
    ...
    /// [Governance] Apply conservative automatic remediations with dry-run preview
    Fix {
    ...
    /// [Governance] Generate a structured fix rollout plan (JSON) from current audit findings
    FixRolloutPlan {
        /// Output file path for the generated plan
        #[arg(long, default_value = "fix-rollout-plan.json")]
        output: String,
    },
    /// [Governance] Approve (or reject) items in a fix rollout plan before applying
    FixRolloutApprove {
    ...
    /// [Governance] Apply approved fixes from a fix rollout plan
    FixRolloutApply {
    ...
    /// [Governance] Show the effective policy after applying org/team/project override precedence
    PolicyResolve {
    ...
    /// [Preset] Install a preset package from a local registry index
    PresetInstall {
    ...
    /// [Preset] Publish a preset package into a local registry index
    PresetPublish {
    ...
    /// [Preset] Verify contract-first and sidecar-first alignment of a preset directory
    PresetVerify {
    ...
    /// [Preset] Generate a migration plan to upgrade a preset version
    PresetMigrationPlan {
    ...
    /// [Preset] Apply a migration plan to upgrade a preset version
